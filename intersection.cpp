...
*/
Intersection *insertIntersection (Image **intersectionImage, Image **intersectionBlock, int num_pixels, Intersection* intersection) {
    ...
    // Pegar o menor e o maior label da imagem da interseção
